...
// ═══════════════════════════════════════════════════════════════════════════
//  ★ Lab1 (Motor) — ค่าที่ "ต้องจูน/บันทึก" ในแล็บนี้ (ค้นหาชื่อด้านล่าง):
//      MOTOR_L_DIRECTION / MOTOR_R_DIRECTION   ทิศหมุน (คำสั่ง f/b/a/d)
//      MOTOR_PWM_MIN                           PWM ต่ำสุดที่ล้อเริ่มหมุน (คำสั่ง m)
//      BATTERY_DIVIDER_RATIO                   คาลิเบรตแบต (คำสั่ง c)
...
#define BATTERY_DIVIDER_RATIO   4.18
