...
// ═══════════════════════════════════════════════════════════════════════════
//  ★ Lab2 (Encoder) — ค่าที่ "ต้องจูน/บันทึก" ในแล็บนี้ (ค้นหาชื่อด้านล่าง):
//      WHEEL_DIAMETER_MM    วัด ⌀ ล้อด้วยเวอร์เนียร์
//      COUNTS_PER_REV       หมุนล้อ 1 รอบ อ่าน count (Step 1)
//      MM_PER_COUNT         โปรแกรม CALC ให้ (= πD / CPR)
