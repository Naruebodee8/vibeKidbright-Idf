...
// ═══════════════════════════════════════════════════════════════════════════
//  ★ Lab3 (IMU) — ค่าที่ "ต้องจูน/บันทึก" ในแล็บนี้ (ค้นหาชื่อด้านล่าง):
//      GYRO_OFFSET_Z              สำคัญสุด — ใช้คุมการหมุน (คำสั่ง c)
//      GYRO_OFFSET_X / _Y         จดไว้ด้วย
//      (ACCEL_OFFSET_* = optional ไม่บังคับ — ไม่ใช้ขับ)
...
#define MOTOR_PWM_MIN           590          // ค่าต่ำสุดที่มอเตอร์เริ่มหมุน ← ทดสอบใน Workshop 1
...
#define WHEEL_BASE_MM           79.0        // ระยะห่างระหว่างล้อ (mm) ← วัดจากหุ่นยนต์จริง
...
#define GYRO_OFFSET_X           -482.1f         // ← จาก Workshop 3 calibration
#define GYRO_OFFSET_Y            245.0f      // ←f จาก Workshop 3 calibration
#define GYRO_OFFSET_Z           -18.9f        // ← จาก Workshop 3 calibration

// Accelerometer offset
#define ACCEL_OFFSET_X          -828.4          // ← จาก Workshop 3 calibration
#define ACCEL_OFFSET_Y          -127.8         // ← จาก Workshop 3 calibration
#define ACCEL_OFFSET_Z          1264.5         // ← จาก Workshop 3 calibration
...
// ┌───────────────────────────────────────────────────────────────────────────
// │ SECTION 12: TELEMETRY CONFIGURATION
// └───────────────────────────────────────────────────────────────────────────

// Telemetry mode (เลือกอันใดอันหนึ่ง)
#define TELEMETRY_WIFI_ENABLED  0           // ปิด WiFi — ใช้ BLE console แทน (สม่ำเสมอกับแลปอื่น)
#define TELEMETRY_SERIAL_ENABLED 1          // Enable Serial fallback

// WiFi Access Point settings
#define WIFI_AP_SSID            "Micromouse" // จะต่อท้ายด้วย _XXXX (MAC)
#define WIFI_AP_PASSWORD        "12345678"   // ขั้นต่ำ 8 ตัวอักษร (ว่าง = open)
#define WIFI_AP_CHANNEL         1
#define WIFI_AP_MAX_CONNECTIONS 2

// WebSocket settings
#define WEBSOCKET_PORT          80
#define TELEMETRY_UPDATE_RATE_HZ 10         // 10 Hz = 100ms interval
#define TELEMETRY_BUFFER_SIZE   1024         // JSON buffer size

// ┌───────────────────────────────────────────────────────────────────────────
// │ SECTION 13: DEBUG FLAGS
// └───────────────────────────────────────────────────────────────────────────
