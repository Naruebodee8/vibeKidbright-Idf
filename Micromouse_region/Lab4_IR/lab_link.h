// ═══════════════════════════════════════════════════════════════════════════
//  lab_link.h — ทำให้แล็บพูดได้ทั้ง USB และ BLE โดยไม่ต้องแก้ทุก Serial.print
//
//  วิธีใช้ (ใน .ino):
//    #include "ble_debug.h"
...
//  เซนเซอร์/HAL ที่ include ก่อนหน้านี้ยังพิมพ์ลง USB ตามปกติ (ไม่กระทบ)
// ═══════════════════════════════════════════════════════════════════════════
#ifndef LAB_LINK_H
#define LAB_LINK_H
...
// เริ่มพอร์ต USB จริง (เรียกก่อน #define Serial จะได้ใช้ Serial ตัวจริง)
...
public:
    ...
    // ── output: tee USB + BLE (BLE สะสมจนเจอ '\n' ค่อยส่งทั้งบรรทัด) ──────────
